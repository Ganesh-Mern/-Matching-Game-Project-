    ...
    <div className="monkey">
      ...
      >
        <path
          ...
          fill="#D2714C"
          stroke="#D2714C"
          stroke-width="0.782983"
        />
        <circle cx="65.6531" cy="218.203" r="64.6531" fill="#D2714C" />
        <g filter="url(#filter0_f_0_143)">
          <circle cx="69.6939" cy="218.204" r="48.4898" fill="#FFE1C2" />
        </g>
        <g filter="url(#filter1_f_0_143)">
          <ellipse
            cx="58"
            cy="242.5"
            rx="28"
        ...
        <g filter="url(#filter4_f_0_143)">
          <path
            d="M618 312.5C618 319.404 623.82 325 631 325C638.18 325 644 319.404 644 312.5C644 305.597 638.18 300 631 300C623.82 300 618 305.597 618 312.5Z"
            fill="white"
            fill-opacity="0.9"
          />
        </g>
        ...
        />
        <path
          d="M481.857 239.021C481.857 334.644 388.687 412.162 273.755 412.162C158.824 412.162 65.6533 334.644 65.6533 239.021C65.6533 143.397 158.824 36.3662 273.755 36.3662C388.687 36.3662 481.857 143.397 481.857 239.021Z"
          fill="#D2714C"
        />
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M99.4648 333.662C101.367 295.62 132.681 262.653 174.198 262.653H373.66C415.021 262.653 446.263 295.376 448.371 333.247C411.265 380.748 346.92 412.162 273.755 412.162C200.804 412.162 136.62 380.931 99.4648 333.662Z"
          fill="#FFE1C2"
        />
        ...
        <circle
          ...
          cy="6.06123"
          r="6.06123"
          transform="matrix(-1 0 0 1 186.876 246.491)"
          fill="white"
        />
        <ellipse
          cx="364.673"
        ...
        <ellipse
          ...
          fill="white"
        />
        <circle cx="374.775" cy="252.55" r="6.06123" fill="white" />
        <path
          d="M306.827 287.491C306.827 295.037 294.942 299.905 280.281 299.905C265.62 299.905 253.735 295.037 253.735 287.491C253.735 279.945 265.62 270.737 280.281 270.737C294.942 270.737 306.827 279.945 306.827 287.491Z"
          fill="#562B30"
        />
        <circle cx="292.46" cy="281.165" r="3.74765" fill="white" />
        <path
          d="M280.161 278.43V306.057C280.161 315.079 287.475 322.392 296.497 322.392H298.779C306.541 322.392 312.833 316.1 312.833 308.339V308.339"
          stroke="#562B30"
          stroke-width="6.87069"
          stroke-linecap="round"
          stroke-linejoin="round"
        />
        <path
          d="M280.161 278.427V306.054C280.161 315.076 272.847 322.39 263.825 322.39H261.543C253.781 322.39 247.489 316.098 247.489 308.336V308.336"
          stroke="#562B30"
          stroke-width="6.87069"
          stroke-linecap="round"
          stroke-linejoin="round"
        />
        <g filter="url(#filter6_f_0_143)">
          <ellipse
            cx="387.306"
            cy="315.224"
            rx="30.3061"
        ...
        <defs>
          ...
          >
            ...
            <feGaussianBlur
              stdDeviation="5.1"
              result="effect1_foregroundBlur_0_143"
            />
          </filter>
          <filter
            id="filter1_f_0_143"
          ...
          >
            ...
            <stop offset="0.280912" stop-color="#A24A29" stop-opacity="0.94" />
